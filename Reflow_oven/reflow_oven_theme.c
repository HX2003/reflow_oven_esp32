...
static void basic_init(void)
{
    ...
    lv_style_set_bg_color(&style_label, LV_STATE_DEFAULT, REFLOW_OVEN_RED);
    ...
    lv_style_set_bg_color(&style_btn, LV_STATE_PRESSED, REFLOW_OVEN_LIGHT_GRAY);
    lv_style_set_bg_color(&style_btn, LV_STATE_FOCUSED, REFLOW_OVEN_LIGHT_GRAY);
    lv_style_set_bg_color(&style_btn, LV_STATE_CHECKED, REFLOW_OVEN_GRAY);
    lv_style_set_text_color(&style_btn, LV_STATE_DEFAULT, REFLOW_OVEN_BLUE);
    lv_style_set_text_color(&style_btn, LV_STATE_PRESSED, lv_color_darken(REFLOW_OVEN_BLUE, LV_OPA_20));
    lv_style_set_text_color(&style_btn, LV_STATE_CHECKED, LV_COLOR_WHITE);
